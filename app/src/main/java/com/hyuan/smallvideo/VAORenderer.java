...
public class VAORenderer
{
    ...
    public VAORenderer ( Context context )
    {
        ...
        mProgramObject = ShaderUtil.createShaderProgram ( vShaderStr, fShaderStr );
    ...
    public void onDrawFrame ( GL10 glUnused )
    {
        ...
        GLES30.glDrawElements ( GLES30.GL_TRIANGLES, mIndicesData.length, GLES30.GL_UNSIGNED_SHORT, mIndices );
